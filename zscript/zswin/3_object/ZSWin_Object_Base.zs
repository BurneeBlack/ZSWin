...
class ZObjectBase : actor abstract
{
	...
	*/
	...
	// So many things can draw lines that this method of calculating offsets is globally useful.
	clearscope static float GetLineThicknessOffset(float thickness, bool offset = false, int amount = 1) { return thickness > 1 ? (thickness % 2 == 0 ? thickness / 2 : ((thickness - 1) / 2) + (offset ? amount : 0)) : thickness; }
	...
	*/
	...
	{
		ZSHandlerUtil.HaltAndCatchFire(EventHandler(EventHandler.Find("ZEventSystem")), msg);
		return null;
	}
	...
	*/
	...
	virtual void ZObj_WorldTick() {}
	virtual void ZObj_WorldLinePreActivated(ZWorldEventPacket e) {}
	virtual void ZObj_WorldLineActivated(ZWorldEventPacket e) {}	
	...
	*/
	...
	virtual void ControlEventCaller(int t) {}
